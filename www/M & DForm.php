...
<body bgcolor="#e9e9e9">
  ...
  <p style="font-size:20px;"><i>The true expression of a people is in its dance and its music. Bodies never lie</i></p>.

<form align="center" action="M&D.php" method="post" onsubmit="return validateMyForm();"> 
