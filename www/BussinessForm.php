...
<body bgcolor="#e9e9e9">
  ...
  <p style="font-size:20px;"><i>Business has only two functions-marketing and innovation</i></p>.

<form align="center" action="Business.php" method="post" onsubmit="return validateMyForm();"> 
